...
function AddPayment() {
      ...
      return (
        <>
          <div className="mb-3">
            ...
            <input
              type="text"
              className="form-control update-duty-form-control"
  ...
  return (
    <>
      <div className="main-container-form-add-payment">
        <div className="">
          <div className=" justify-content-center">
            <div className="">
              <div className="card-body mt-5 mb-5">
                ...
                <form className="width-set-for-form-add-payment-cc">
                  <div className="responsive-flex-column-required contain-inputs-for-add-payment-zero-gap flex ">
                  ...
                  <div className="responsive-flex-column-required contain-inputs-for-add-payment-zero-gap flex ">
                    ...
                    <div className="col-md">
                      <div className="form-group">
                        ...
                        <input
                          type="number"
                          className="add-payment-form-control form-control"
                          name="toll"
                  ...
                  <div className="responsive-flex-column-required contain-inputs-for-add-payment-zero-gap flex "></div>
