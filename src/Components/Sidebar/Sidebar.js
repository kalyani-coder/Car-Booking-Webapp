...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className="sidebar"
        style={{ position: "fixed", overflowY: "auto", maxHeight: "50vh" }}
      >
        <div
          className="logo"
          style={{
        ...
        <ul className="nav-list">
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/viewmaster"}>View Master</Link>
                </a>
              </li>
            </ul>
          </div>{" "}
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/viewvendor"}>View Vendor</Link>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/corporatecustomer"}>Corporate Customer Rate</Link>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/viewcorporatecustomer"}>
              ...
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/vendorrate"}>Vendor Rate</Link>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/viewvendorrate"}>View Vendor Rate</Link>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/customerenquiry"}>Add Customer Enquiry</Link>
                </a>
              </li>
              <hr />
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/viewcustomerenquiry"}>View Customer Enquiry</Link>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/allocatetrip"}>Allocate Trip</Link>
                </a>
              </li>
              <hr />
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/ViewAllocateTrip"}>View Allocate Trip</Link>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/sharedetails"}>Share Trip Details</Link>
                </a>
              </li>
              <hr />
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/viewsharedetails"}>View Share Details</Link>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/startenddetails"}>Get Trip Details</Link>
                </a>
              </li>
              <hr />
              <li>
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/updateduty"}>Add Duty Slip</Link>
                </a>
              </li>
              <hr />
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/viewupdateduty"}>View Duty Slip</Link>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div class="btn-group">
            <button
              ...
              aria-expanded="false"
            >
              <AiFillBank className="user-icon" />
              Payment
            </button>
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/addcustomerpayment"}>Customer Payment</Link>
                </a>
              </li>

              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/viewcustomerpayment"}>View Customer Payment</Link>
                </a>
              </li>
              <hr />
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/vendorpayment"}>Vendor Payment</Link>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/viewvendorpayment"}>View Vendor Payment</Link>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div class="btn-group">
            <button
              ...
              aria-expanded="false"
            >
              <FaFileInvoiceDollar className="user-icon" />
              Generate Invoice
            </button>
            <ul class="dropdown-menu">
              <li>
              ...
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/customerinvoice"}>Customer Invoice</Link>
                </a>
              </li>
              {/* <li><a class="dropdown-item" href="#">
          ...
          <div class="btn-group">
            <button
              ...
              aria-expanded="false"
            >
              <AiOutlineFilePdf className="user-icon" />
              Generate Report
            </button>
            <ul class="dropdown-menu">
              <li>
              ...
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/vendorreport"}>Vendor Report</Link>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="#">
                  <Link to={"/tripdetailsreport"}>Trip Details Report</Link>
                </a>
              </li>
            </ul>
          </div>
