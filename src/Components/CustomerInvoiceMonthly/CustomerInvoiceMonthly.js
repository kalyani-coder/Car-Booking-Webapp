...
function CustomerInvoiceMonthly() {
  ...
  return (
    <div className="container-customer-invoice-monthly">
      ...
      {/* Display selected customer data in a table */}
      {selectedCustomer && (
        <div>
          ...
          <table className="invoice-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{selectedCustomer.vehicle_Type}</td>
                <td>{`${selectedCustomer.vehicle_Type} from ${selectedCustomer.from} to ${selectedCustomer.to}`}</td>
                <td>{selectedCustomer.total_Km}</td>
              </tr>
